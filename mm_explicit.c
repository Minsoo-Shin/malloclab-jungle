...
int mm_init(void)
{
    ...
    heap_listp += (2*WSIZE);
    last_bp = heap_listp;
    // point prologue start point footer.  what it means :  
...
static void *find_fit(size_t asize)
{
    ...
    // 글로벌 변수로 next fit last bp 저장한 다음, last bp으로 시작한다. 
    return NULL; /* No fit */
}
...
// static void *find_fit(size_t asize)
// {
//     /* First-fit search : always search free block from first of heap area*/
//     void *bp;
